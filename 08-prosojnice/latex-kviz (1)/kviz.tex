...
\begin{enumerate}
    ...
    \item Pravilni odgovori so: (c) $\cos x$ (b) $\mathrm{cos}~x$ (d) $\text{cos}~x$ (e) $\operatorname{cos} x$% tu napišite vse pravilne odgovore
    
    \item Pravilni odgovori so: (b) $\emptyset$ (c) ${} \{\}$% tu napišite vse pravilne odgovore
    
    \item Taylorjev razvoj funkcije $\sin x$ do tretjega člena: $$\sin x = x - \frac{x^3}{3!}+\mathcal{O}(x^5)$$

    \item Pravilni odgovori so:  (a) (b)% tu naštejte vse pravilne odgovore
    % (a)
      \[ e^{i \pi} + 1 = 0 \]
    % (b)
      \begin{center}
    ...
    \item Pravilni odgovori so: (c)% tu naštejte vse pravilne odgovore
        \begin{enumerate}
          % (a)
            \item {
